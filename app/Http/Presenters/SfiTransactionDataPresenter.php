...
class SfiTransactionDataPresenter extends PresenterCore
{
    ...
    public function getPreparedSfiTransactionData($summary=false)
    {
    	$querySales = '
				...
				CONCAT(substr(all_so.invoice_number,1,2) ,\'-\',IF(remarks.remarks=\'\',ac.customer_name,COALESCE(remarks.remarks,ac.customer_name))) header_text,
				IF(substr(all_so.customer_code,1,1) = \'1\', \'110000\',\'110010\') gl_account,
				IF(substr(all_so.customer_code,1,4) = \'1000\', \'O1\',\'OX\') tax_code,
				pc.profit_center,
				CONCAT(sc.abbreviation,\'-\',IF(remarks.remarks=\'\',ac.customer_name,COALESCE(remarks.remarks,ac.customer_name))) detail_text,
    	...
    	$queryReturns = '
				...
				CONCAT(substr(trh.return_slip_num,1,2) ,\'-\',IF(remarks.remarks=\'\',ac.customer_name,COALESCE(remarks.remarks,ac.customer_name))) header_text,
