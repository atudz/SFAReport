...
class ReportsPresenter extends PresenterCore
{
    ...
    public function getPreparedSalesReportMaterial($summary=false)
    {
    	...
    	$queryReturns = '
				...
				trd.condition_code,
				trd.uom_code,
				CONCAT(\'(\',trd.gross_amount,\')\') gross_served_amount,
				CONCAT(\'(\',trd.vat_amount,\')\')  vat_amount,
				0 discount_rate,
				trd.discount_amount,
			    ...
			    CONCAT(\'(\',((trd.gross_amount + trd.vat_amount) - (coalesce((trd.gross_amount + trd.vat_amount),0.00)*(trhd.deduction_rate/100))),\')\') total_invoice,
			    IF(trh.updated_by,\'modified\',IF(trd.updated_by,\'modified\',\'\')) updated,
