...
class ReplenishmentAdjustmentSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
    	...
    	$navigation_item = [
    			['name'=>'Adjustment Replenishment','url'=>'vaninventory.adjustment','class'=>'glyphicon glyphicon-share-alt','parent_id'=>'3','order'=>6,'created_at' => $today,'updated_at'=>$today],
    	];
