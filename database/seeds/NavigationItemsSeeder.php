...
class NavigationItemsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $navigation_item = [
                ...
                ['name'=>'Master (Customer)','url'=>'salesreport.customerlist','class'=>'glyphicon glyphicon-share-alt','navigation_id'=>'5','created_at' => new DateTime()],
                ['name'=>'Master (Salesman)','url'=>'salesreport.salesmanlist','class'=>'glyphicon glyphicon-share-alt','navigation_id'=>'5','created_at' => new DateTime()],
                ['name'=>'Master (Material Price)','url'=>'salesreport.materialpricelist','class'=>'glyphicon glyphicon-share-alt','navigation_id'=>'5','created_at' => new DateTime()],
