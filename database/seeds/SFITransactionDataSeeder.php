...
class SFITransactionDataSeeder extends Seeder
{
    ...
    {
        $navigation_id = DB::table('navigation')->where('slug', '=', 'sfi-transaction-data')->value('id');
    ...
    {
        $navigation_id = DB::table('navigation')->where('slug', '=', 'profit-centers')->value('id');
    ...
    {
        $navigation_id = DB::table('navigation')->where('slug', '=', 'gl-accounts')->value('id');
    ...
    {
        $navigation_id = DB::table('navigation')->where('slug', '=', 'segment-codes')->value('id');
    ...
    {
        $navigation_id = DB::table('navigation')->where('slug', '=', 'document-types')->value('id');
