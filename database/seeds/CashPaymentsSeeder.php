...
class CashPaymentsSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
    	...
    	$navigation_item = [
    			['name'=>'Cash Payments','url'=>'cashpayments','class'=>'glyphicon glyphicon-share-alt','parent_id'=>2,'order'=>4,'created_at' => $today,'updated_at'=>$today],
    	];
