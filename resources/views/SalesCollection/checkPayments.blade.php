							...
							<tr ng-repeat="record in records|filter:query" id="records-[[$index]]" class="[[record.has_delete_remarks]]">
								...
								<td id="records-[[$index]]-bank_updated" class=[[record.bank_updated]]>
									@if($isAdmin || $isAuditor)
										<a href="" class="editable-click" ng-click="editColumn('text','txn_collection_detail','bank',record.collection_detail_id,record.bank,$index,'Bank Name','bank','','','','bank_updated','check-payments',('records-' + $index))">
								...
								<td id="records-[[$index]]-payment_amount_updated" class=[[record.payment_amount_updated]]>
									@if($navigationActions['show_check_amount_column'] && $navigationActions['edit_check_amount_column'])
										<a href="" class="editable-click" ng-click="editColumn('text','txn_collection_detail','payment_amount',record.collection_detail_id,record.payment_amount,$index,'Payment Amount','payment_amount','','','','payment_amount_updated','check-payments',('records-' + $index))" ng-if="record.closed_period == 0">
								...
								<td id="records-[[$index]]-delete_remarks_updated" class="[[record.delete_remarks_updated]]">
									@if($navigationActions['show_delete_remarks_column'] && $navigationActions['edit_delete_remarks_column'])
										<a href="" class="editable-click" ng-click="editColumn('text',record.delete_remarks_table,'delete_remarks',record.delete_remarks_id,record.delete_remarks,$index,'Remarks','','','','','delete_remarks_updated','check-payments',('records-' + $index))">
