...
Html::macro('datepicker', function($name, $label, $fromTo=false, $controller='Calendar') {
	...
	$html = '<div class="form-group form-group-sm">
			 	...
			 	<p class="input-group">
			 		<input type="text" id="'.$name.'_from" name="'.$name.'_from" show-weeks="true" ng-click="open($event,\''.$name.'_from\')" class="form-control" uib-datepicker-popup="[[format]]" ng-model="dateFrom" is-open="'.$name.'_from" datepicker-options="dateOptions" close-text="Close"'.$placeholderFrom.' onkeydown="return false;"/>
