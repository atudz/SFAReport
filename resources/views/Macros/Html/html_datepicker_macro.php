...
Html::macro('datepicker', function($name, $label, $fromTo=false, $monthOnly=false, $from='', $to='', $controller='Calendar', $yearOnly=false,$disabled = false) {
	...
	$html = '<div class="form-group">
			 	...
			 	<p class="input-group">
			 		<input ng-init="setFrom(\''.$from.'\')" type="text" id="'.$name.'_from" name="'.$name.'_from" show-weeks="true" ng-click="open($event,\''.$name.'_from\')" class="form-control" uib-datepicker-popup="[[format]]" ng-model="dateFrom" is-open="'.$name.'_from" datepicker-options="'.$options.'" close-text="Close"'.$placeholderFrom.' onkeydown="return false;" ng-disabled="'.$disabled.'"/>';
