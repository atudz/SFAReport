        ...
        <div class="col-xs-12 col-md-6 col-lg-3">
            <div class="panel panel-orange panel-widget">
                <div class="row no-padding">
                    ...
                    <div class="col-sm-9 col-lg-7 widget-right">
                        <div class="large">{{$unpaidTotal}}</div>
         ...
         <div class="col-xs-12 col-md-6 col-lg-3">
            <div class="panel panel-gold panel-widget">
                <div class="row no-padding">
                    ...
                    <div class="col-sm-9 col-lg-7 widget-right">
                        <div class="large">{{$salesTotal}}</div>
    ...
    <div class="row">
       ...
       <!--  <div class="col-xs-12 col-md-6 col-lg-3">
            <div class="panel panel-gray panel-widget ">
                <div class="row no-padding">
                    <div class="col-sm-3 col-lg-5 widget-left">
                        <em class="glyphicon glyphicon-info-sign glyphicon-l"></em>
                    </div>
                    <div class="col-sm-9 col-lg-7 widget-right">
                        <div class="large"><a href="#sync">Sync</a></div>
                        <div class="text-muted"><a href="#sync">Data</a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-md-6 col-lg-3">
            <div class="panel panel-gray panel-widget">
                <div class="row no-padding">
                    ...
                    <div class="col-sm-9 col-lg-7 widget-right">
                        <div class="large"><a href="#user.list">User</a></div>
                        <div class="text-muted"><a href="#user.list">Management</a></div>
                    </div>
                </div>
            </div>
        </div> -->
