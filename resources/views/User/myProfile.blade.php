			...
			<div class="panel-body">
				...
				{!!Form::open(['class'=>'changepassword-form'])!!}
					<div class="form-group row">
						...
						<div class="col-sm-5">
					      <input ng-model="records.firstname" type="text" name="fname" id="fname" class="form-control" placeholder="">
					    </div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
					      <input ng-model="records.middlename" type="text" name="mname" id="mname" class="form-control" placeholder="">
					    </div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
					      <input ng-model="records.lastname" type="text" name="lname" id="lname" class="form-control" placeholder="">
					    </div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
								<select id="gender" name="gender" class="form-control" ng-model="records.gender">
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
					      <input ng-model="age" type="number" name="age" id="age" class="form-control" placeholder="" min="0">
					    </div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
					      <input ng-model="records.address1" type="text" name="address" id="address" class="form-control" placeholder="">
					    </div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
					      <input ng-model="records.email" type="text" name="email" id="email" class="form-control" placeholder="">
					    </div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
					      <input ng-model="records.telephone" type="text" name="telephone" id="telephone" class="form-control" placeholder="">
					    </div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
					      <input ng-model="records.mobile" type="text" name="mobile" id="mobile" class="form-control" placeholder="">
					    </div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input ng-model="records.username" type="text" name="username" id="username" class="form-control" placeholder="">
					    </div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
								<select id="role" id="role" class="form-control" ng-model="records.user_group_id">
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
								<select id="area" class="form-control" ng-model="records.location_assignment_code"> 
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
								<select id="assignment_type" class="form-control" ng-model="records.location_assignment_type">
